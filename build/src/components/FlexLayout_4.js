import { Color, FlexDirection, flexlayout, Gravity, Justify, layoutConfig, stack, text, vlayout, Wrap } from "doric";
...
function exampleUI(flexWrap, boxes) {
    var desc;
    switch (flexWrap) {
        case Wrap.NO_WRAP:
            desc = 'NO_WRAP';
...
//# sourceMappingURL=FlexLayout_4.js.map