...
import { Panel, Text, text, Color, Stack, vlayout, hlayout, scroller, layoutConfig, Gravity, GradientOrientation } from "doric";
...
let EffectsDemo = class EffectsDemo extends Panel {
    build(rootView) {
        scroller(vlayout([
            hlayout([
                vlayout([
