...
function ui$p() {
    return doric.vlayout([
        ...
        doric.text({
            ...
            textSize: 20,
            font: new doric.AssetsResource('/fonts/iconfont.ttf'),
        }),
        doric.text({
        ...
        doric.text({
            text: "Font from custom loader.",
            textSize: 22,
            font: new doric.AssetsResource('/fonts/Hanabi.ttf')
        }),
    ], {
        space: 10,
        gravity: doric.Gravity.Left,
...
function ui$e() {
    return doric.stack([
        doric.vlayout([
            ...
            doric.image({
                image: new doric.AssetsResource("coupon_bg2.png"),
                height: 48,
                width: 78,
...
function ui$d() {
    ...
    return doric.jsx.createElement(doric.Stack, { layoutConfig: doric.layoutConfig().mostWidth().fitHeight(), backgroundColor: bgColor, padding: { left: 10, right: 10, top: 10, bottom: 10 } },
        doric.jsx.createElement(doric.VLayout, { layoutConfig: doric.layoutConfig().mostWidth().fitHeight(), gravity: doric.Gravity.Center, space: 20 },
            doric.jsx.createElement(doric.Image, { image: new doric.AssetsResource("coupon_bg2.png"), height: 48, width: 78, scaleType: doric.ScaleType.ScaleAspectFill, layoutConfig: doric.layoutConfig().just() }),
...
function ui$c() {
    return doric.stack([
        doric.vlayout([
            doric.image({
                image: new doric.AssetsResource("dididi.png"),
                height: 78,
                width: 84,
            ...
            doric.image({
                ...
                imageScale: 1,
                backgroundColor: doric.Color.BLACK,
                scaleType: doric.ScaleType.Tile,
                layoutConfig: doric.layoutConfig().just(),
            }),
            doric.image({
                image: new doric.AssetsResource("123.png"),
                height: 288 / 2,
                width: 154 / 2,
                scaleType: doric.ScaleType.ScaleAspectFill,
                layoutConfig: doric.layoutConfig().just(),
...
function caseUIorCode(path, needCode) {
    switch (path) {
        case "Text_1":
            return needCode ? codeString$r() : ui$r();
        case "Text_2":
            return needCode ? codeString$q() : ui$q();
        case "Text_3":
...
var localComponentJson = [
	...
	},
	{
		...
		cases: [
			...
			{
				title: "字体文件使用",
				desc: "【font】：字体文件名\n支持从bundle加载 font: new AssetsResource('/fonts/Hanabi.ttf')",
				ui: "Text_3"
			},
			{
				title: "字体渐变色",
