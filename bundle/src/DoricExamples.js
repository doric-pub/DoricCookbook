...
AnimatedImageDemo = __decorate$h([
    Entry
], AnimatedImageDemo);
...
ComplicatedAnimationDemo = __decorate$f([
    Entry
...
TextAnimationDemo = __decorate$7([
    Entry
], TextAnimationDemo);
...
GestureContainerDemo = __decorate$3([
    Entry
