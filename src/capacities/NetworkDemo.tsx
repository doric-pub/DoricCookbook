import { Color, createRef, Gravity, gravity, Group, HLayout, jsx, layoutConfig, log, modal, network, Panel, Scroller, Stack, Text, VLayout } from "doric";
...
export class NetworkDemo extends Panel {
    build(rootView: Group): void {
        ...
        const resUploadText = createRef<Text>();
